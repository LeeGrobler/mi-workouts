  ...
  <v-card tile>
    <v-card-text>
      ...
      <ul>
        ...
        <li>
          <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named MiWorkouts</p>
        </li>
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to MiWorkouts.</p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Website</strong> refers to MiWorkouts, accessible from <a href="https://mi-workouts.com" rel="external nofollow noopener" target="_blank">https://mi-workouts.com</a></p>
        </li>
        <li>
